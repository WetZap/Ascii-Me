...
# Paleta ASCII para la generación
ASCII_CHARS = " .'`^\",:;Il!i><~+_-?][}{1234567890)(|\\/tfjrxnuvczXYUJCLQ0OZmwqpdbkhao*#MW&8%B@$"
FRAME_DELAY = 0.06

# Configuración de fondo
BG_COLOR = (255, 255, 255)  # Color de fondo a eliminar (blanco)
BG_THRESHOLD = 50  # Sensibilidad para la detección de fondo
ASPECT_RATIO_FACTOR = 0.48  # Factor de corrección para relación de aspecto
